---
title       : The Pulse Rates dataset (and others..)
...
The intention is to provide an application that allows the user to explore, through plotting, various aspects of the data. The structure of the data is shown below. The data is fully documented at "http://www.statsci.org/data/oz/ms212.html".
